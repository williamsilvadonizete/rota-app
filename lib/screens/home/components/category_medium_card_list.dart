...
class CategoryMediumCardList extends StatefulWidget {
  ...
  @override
  State<CategoryMediumCardList> createState() => _CategoryMediumCardListState();
}

class _CategoryMediumCardListState extends State<CategoryMediumCardList> {
  bool isLoading = true;
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => SearchScreen(
                              initialCategory: widget.restaurants[index]['name'],
                              initialCategoryId: widget.restaurants[index]['id'],
                            ),
                          ),
                        );
                      },
